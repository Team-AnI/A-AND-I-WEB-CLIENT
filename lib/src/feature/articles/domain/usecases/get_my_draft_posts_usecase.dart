...
/// 내 임시저장 게시글 목록 조회 유스케이스입니다.
class GetMyDraftPostsUsecase {
  /// 내 임시저장 게시글 목록 조회 유스케이스를 생성합니다.
  const GetMyDraftPostsUsecase(this.postRepository);

  /// 게시글 저장소입니다.
  final PostRepository postRepository;

  /// 내 임시저장 게시글 목록을 조회합니다.
  Future<PostPage> call({
    int page = 0,
    int size = 20,
    PostType? type,
  }) {
    return postRepository.getDraftPosts(page: page, size: size, type: type);
  }
}
